...
namespace Arrowgene.Ddon.GameServer.Characters
{
    public class JobOrbUnlockManager
    {
        ...
        {
            if (!gJobOrbUpgrades.ContainsKey(jobId))
            {
                return new List<CDataJobOrbDevoteElement>();
            }

            return gJobOrbUpgrades[jobId].Select(x => x.ToCDataJobOrbDevoteElement()).ToList();
        }

        private class JobOrbUpgrade
        {
            ...
            public SecretAbility Augment { get; private set; }
            ...
            public JobOrbUpgrade Unlocks(SecretAbility augment)
            {
            ...
            {
                this.UnlockDependencies.Add(new CDataCommonU32() { Value = elementId });
                return this;
            }
